...
from modules.inpainters.lama.saicinpainting.evaluation import make_evaluator
...
from modules.inpainters.lama.saicinpainting.training.losses.adversarial import (
    make_discrim_loss,
)
from modules.inpainters.lama.saicinpainting.training.losses.perceptual import (
    PerceptualLoss,
    ResNetPL,
)
from modules.inpainters.lama.saicinpainting.training.modules import (
    make_generator,
    make_discriminator,
)
from modules.inpainters.lama.saicinpainting.training.visualizers import make_visualizer
from modules.inpainters.lama.saicinpainting.utils import (
    add_prefix_to_keys,
    average_dicts,
    set_requires_grad,
    flatten_dict,
...
class BaseInpaintingTrainingModule(ptl.LightningModule):
    ...
    def _do_step(
        ...
        if mode == "val":
            ...
            result[f"extra_val_{extra_val_key}_evaluator_state"] = (
